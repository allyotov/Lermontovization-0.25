...
shape_ids = {'ADJF': 'имя прилагательное (полное)',
             'ADJS': 'имя прилагательное (краткое)',
             'Adjx': 'может выступать в роли прилагательного',
             'CAse': 'категория падежа',
             'COMP': 'компаратив',
             ...
             'sing': 'единственное число',
             'voct': 'звательный падеж'}
substantiv = {'Subx': 'возможна субстантивация'}  # возможная субстантивация не влияет на форму слова, но на часть речи
redundant_grammemes = {'Subx', 'Qual', 'anim', 'inan'}  # граммемы, не влияющие на форму прилагательного
shaping_grammemes = {'ADJF',
                     'ADJS',
                     'Adjx',
                     'CAse',
                     'COMP',
