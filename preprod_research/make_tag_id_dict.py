...
copy_paste = '''1	POST	ЧР	часть речи	—
...
for line in copy_paste.split('\n'):
    ...
    number_to_rus[num] = rus
    rus_to_id[rus] = id
    id_to_rus[id] = rus
    id_to_num[id] = num

pprint.pprint(number_to_rus)
pprint.pprint(rus_to_id)
pprint.pprint(id_to_num)
pprint.pprint(id_to_rus)
